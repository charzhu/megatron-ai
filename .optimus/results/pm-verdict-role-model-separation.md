...
**Date:** 2026-03-11
**Proposal:** `.optimus/proposals/PROPOSAL_role_model_separation.md`
...
8. **Rebuild and test** (`npm run build` in `optimus-plugin`), verify that model names are rejected and structured input is accepted.
