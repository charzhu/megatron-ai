...
When `worker-spawner.ts` dispatches a task to `.megatron/agents/qa-engineer.md`:
- We write a lock file alongside it, e.g., `.megatron/agents/qa-engineer.md.lock`, containing the current `pid` of the assigned process.
