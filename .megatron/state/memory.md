...
| `src/managers/MemoryManager.ts` | File I/O for `.megatron/memory.md` (read/append/clear) |
...
5. Results stored in VS Code `globalState` under keys `'megatronTaskStates'` and `'megatronSessions'`

### Storage Locations

- Task state: VS Code globalState (`megatronTaskStates`), max 25 tasks
- Session history: VS Code globalState (`megatronSessions`), max 50 sessions
- Project memory: `.megatron/memory.md` (this file)
- Project rules: `.megatron/rules.md`
