...
1. `.megatron/skills/agent-creator/SKILL.md`
2. `.megatron/skills/council-review/SKILL.md`
3. `.megatron/skills/delegate-task/SKILL.md`
4. `.megatron/skills/git-workflow/SKILL.md`
5. `.megatron/skills/task-dashboard/SKILL.md`

## Instructions
1. **Understand the Standard**: Review `.megatron/skills/skill-creator/SKILL.md` to understand the target `<template>`, mandatory `<instructions>`, `<workflow>`, `<error_handling>`, and `<anti_patterns>` XML tags.
...
4. **Save Files**: Overwrite the original files in their respective `.megatron/skills/<skill-name>/SKILL.md` paths.
