...
When adding new tools to an existing MCP server (rather than building one from scratch), follow this streamlined process. This is the common case in established projects like Megatron.
