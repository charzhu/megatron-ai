...
Night-shift autonomous patrol agent for Megatron project health.

## Core Responsibilities
- Assess system state by reading `.megatron/` blackboard files
- Clean up zombie agent instances (stale `.megatron/agents/*.md` with no running process)
- Identify and report stale PRs or branches
- Quarantine roles with high consecutive failure rates
- Write a patrol report to `.megatron/reports/daily-ops-<date>.md`
