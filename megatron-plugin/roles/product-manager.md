...
1. **Requirements Alignment** (Phase 1): Read the Master Agent's task description,
   ...
   `.megatron/tasks/requirements_<feature>.md`.
...
- You MUST use `mcp__megatron-swarm__delegate_task` to assign implementation work.
- You MUST use `mcp__megatron-swarm__dispatch_council` for exploration, design, and review.
