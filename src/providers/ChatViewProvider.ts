            ...
            <div id="chat-view" class="view active">
                ...
                <div class="chat-history" id="chat-history">
                    <div class="message agent">
                        <div class="agent-name">üèõÔ∏?Optimus Council</div>
                ...
                <div class="input-area">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
                        ...
                        <vscode-button appearance="icon" aria-label="Configure Agents" id="config-btn" title="Configure Agents & Roles">
                            <span class="codicon codicon-settings-gear"></span> ‚öôÔ∏è
                        </vscode-button>
                    </div>
                    <div style="display: flex; gap: 8px;">
                        <vscode-dropdown id="mode-selector" style="width: 120px;" title="Operation Mode">
                            <vscode-option value="plan" selected>üìã Plan</vscode-option>
                            <vscode-option value="agent">üöÄ Agent</vscode-option>
                            <vscode-option value="ask">üí¨ Ask</vscode-option>
                        </vscode-dropdown>
                ...
                window.addEventListener('message', event => {
                    ...
                    if (message.type === 'updateAgentSelector') {
                        ...
                        message.sessions.forEach(s => {
                            ...
                            div.textContent = \`üïí \${dateStr} - \${s.prompt}\`;
                        ...
                        let html = \`<div class="agent-name">üèõÔ∏?Council Verdict (Restored)</div><div class="council-container">\`;
                        ...
                        message.session.responses.forEach(r => {
                            ...
                            html += \`
                                <div class="agent-column">
                                    <div class="task-item">
                                        <span class="task-icon">\${r.status === 'success' ? '‚ú? : '‚ù?}</span> 
                        ...
                        let html = \`<div class="agent-name" id="council-status-\${Date.now()}">‚è?Council is deliberating...</div>\`;
                        ...
                        if (taskEl && contentEl) {
                            ...
                            taskEl.querySelector('.task-icon').textContent = message.status === 'success' ? '‚ú? : '‚ù?;
                        ...
                        if (currentCouncilHeader) {
                            ...
                            if (headerEl) {
                                headerEl.textContent = "üèõÔ∏?Council Verdict";
                            }
                        }
                    }
                });
